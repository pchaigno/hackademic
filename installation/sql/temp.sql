...
INSERT INTO `challenges` (`id`, `title`, `pkg_name`, `description`, `congratulation_page`, `author`, `category`, `date_posted`, `visibility`, `publish`, `abstract`, `level`, `duration`, `goal`, `solution`, `availability`, `default_points`, `default_duration`) VALUES
